...
class Archiver {
  async compress(dir) {
    ...
    // The '--' is used to separate the list of files from the options,
    // ensuring that any file names that start with a dash are not misinterpreted as options.
    const args = ['cf', archiveFile, '--', ...files];
